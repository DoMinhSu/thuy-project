                                ...
                                <tbody>
                                    @foreach ($data as $model)
                                        <tr>
                                            ...
                                            <th scope="row">{{ $model->phone_number }}</th>
                                            <th scope="row">{{ $model->address }}</th>
                                            <th scope="row">
                                                <div class="buttons">
                                                    <a href="#" data-id="{{ $model->id }}"
                                                        class="editButton btn btn-success">Edit</a>
                                                    <a href="{{ route('admin.customers.delete', ['model' => $model->id]) }}"
...
@push('javascript')
    <script>
        const updateUrl = "{!! route('admin.customers.update') !!}";
        const createUrl = "{!! route('admin.customers.store') !!}";
