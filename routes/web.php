...
use App\Services\HandleCrawlObserver;
...
Route::get('/testQueueAndSupervisor', function () {
    ...
    // dd(Cache::get('bar', 'default'));
    LogJob::dispatch()->onQueue('podcasts');
});
Route::get('crawling', function () {
    ...
    Crawler::create()
        ...
        // ->setConcurrency(1)
        ->setCrawlObserver(new HandleCrawlObserver)
        // ->setCrawlQueue($queue)
        ...
        ->startCrawling('http://www.nettruyenvip.com/');
});
